...
public class TelaLogin {
    ...
    public static void main(String[] args) {
        ...
        JLabel titulo = new JLabel(
            "<html><center><h2>Login:</h2></center></html>",
        ...
        formPanel.setBackground(new Color(0, 206, 209));

        JLabel usuarioLabel = new JLabel("Nome do Usuário:");
        JTextField usuarioField = new JTextField();
        usuarioField.setHorizontalAlignment(SwingConstants.CENTER);
        usuarioField.setMaximumSize(new Dimension(230, 30));

        JLabel senhaLabel = new JLabel("Senha do Usuário:");
        ...
        buttonPanel.setBackground(new Color(00, 206, 209));
